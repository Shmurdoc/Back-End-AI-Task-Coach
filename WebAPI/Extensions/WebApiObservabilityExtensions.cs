...
public static class WebApiObservabilityExtensions
{
    public static void MapMetrics(this WebApplication app)
    {
        ...
        {
            // Get the default Prometheus metrics output first
            ...
            {
                // If Prometheus metrics fail, we'll just use static metrics
                prometheusMetrics = string.Empty;
            }
            ...
            // Always include nudges_delivered first, then other metrics
